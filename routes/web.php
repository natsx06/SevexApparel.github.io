...
Route::controller(ClientController::class)->group(function(){
    ...
    Route::get('/spesific-product', 'SpesificProduct')->name('spesificproduct');
});
...
Route::middleware(['auth', 'role:user'])->group(function(){
    Route::controller(ClientController::class)->group(function(){
        ...
        Route::get('/search-bar/{id}', 'SearchBar')->name('searchbar');
    });
});
...
Route::middleware(['auth', 'role:admin'])->group(function(){
    ...
    Route::controller(CategoryController::class,'index')->group(function(){
    ...
    Route::controller(SubCategoryController::class,'index')->group(function(){
    ...
    Route::controller(OrderController::class,'index')->group(function(){
