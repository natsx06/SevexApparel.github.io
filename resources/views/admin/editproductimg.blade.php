        ...
        <div class="card-body">
            <form action="{{ route('updateproductimg') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <img style="height: 250px" src="{{ asset($productinfo->product_img) }}" alt="">
                    </div>
                </div>
