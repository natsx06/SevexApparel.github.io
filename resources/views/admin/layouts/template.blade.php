...
>
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="    {{ asset('dashboard/assets/img/favicon/sevex.png') }}" />
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="{{ route('admindashboard') }}" class="menu-link">
                <i class="fa-solid fa-house-chimney-user fa-bounce"></i>&nbsp; &nbsp; 
            ...
            <li class="menu-item">
              <a href="{{ route('pendingorder') }}" class="menu-link">
                <i class="fa-solid fa-rotate-right fa-bounce"></i>&nbsp; &nbsp; 
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <span class="fw-semibold d-block">Natsx</span>
                    ...
                    <li>
                      <a class="dropdown-item" href="auth-login-basic.html">
                        <i class="fa-solid fa-power-off fa-bounce"></i>&nbsp; &nbsp;
